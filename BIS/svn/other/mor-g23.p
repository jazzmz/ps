...
/*
   ...
   Parameters: Input: RID -  RecID(op)
      ...
      Used by:
      Created: 16/09/05 16:46:03
     Modified:
*/
Form "~n@(#) mor-g23.p 1.0 RGen 16/09/05 RGen 16/09/05 [ AutoReport By R-Gen ]"
...
put unformatted "    ── наименование учреждения банка ───────────────────              " datap Format "x(20)"
                "" skip.
put unformatted "                                               ┌──────┐                ──────────────────" skip.
put unformatted "    МЕМОРИАЛЬНЫЙ ОРДЕР ПО ВЫДАЧЕ ЦЕННОСТЕЙ   N │" DNum Format "x(6)"
                "│                    дата выдачи" skip.
...
put unformatted "    ─────────────────────                                 ┌──────────────────────────────┐" skip.
put unformatted "       дата списания                                      │Сч.N " cr Format "x(25)"
                "│" skip.
put unformatted "                                                          └──────────────────────────────┘" skip.
put unformatted "    " NameCl[1] Format "X(72)"
                "" skip.
put unformatted "    " NameCl[2] Format "x(72)"
                "" skip.
...
put unformatted "                                    ИТОГО...     │" Q-t Format "x(6)"
                ...
                "" skip.
put unformatted "                                                 └──────┴────────────────┴────────────────" skip.
put unformatted "    Сумма прописью " Amtp Format "x(66)"
                "" skip.
put unformatted "    " Amtp1 Format "x(86)"
                "" skip.
put unformatted "    Указанную сумму получил ____________  Подпись исполнителя:___________/" user-op Format "x(15)"
                "/" skip.
