...
skip(1)
"                              СВОДНАЯ СПРАВКА О КАССОВЫХ ОБОРОТАХ" skip
...
.                         
      ...
      put unformatted skip(1)
          " Заведующий кассой" _user._user-name at 40 skip
      ...
      if available branch then
         put unformatted
            " " branch.cfo-title branch.cfo-name format "x(25)" at 40 skip.
      else
         put unformatted
            " Главный бухгалтер" skip.
      put unformatted
         "                      ────────────────" "─────────────────────" at 40 skip
                                                 "(расшифровка подписи)" at 40 skip
      .
      page.
   end.
end.
