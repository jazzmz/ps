...
/* Вычисление значения специального поля docum */
docum[1] = substring(GetXAttrValue("op",string(op.op),"Докум"),1,77).
docum[2] = substring(GetXAttrValue("op",string(op.op),"Докум"),78,90).
if docum[1] = "" then 
do:
...
put unformatted "                                                 ┌──────┐" skip.
put unformatted "      МЕМОРИАЛЬНЫЙ ОРДЕР ПО ВЫДАЧЕ ЦЕННОСТЕЙ   № │" DNum Format "x(6)"
                "│          ────────────────────" skip.
...
put unformatted "      " Amtp1 Format "x(86)"
                "" skip.
put skip(1).
put unformatted "      Означенные ценности получил" skip.
put unformatted "      " NameCl[1] Format "x(90)"
                "" skip.
put unformatted "      " NameCl[2] Format "x(90)"
                "" skip.
put unformatted "      по паспорту  " Docum[1] Format "x(77)"
                "" skip.
...
put unformatted "                                   ─────────────────────────          ────────────────────────────────" skip.
put skip(1).
put unformatted "      Выдал кассир" skip.
put unformatted "                                   ─────────────────────────          ────────────────────────────────" skip.
put skip(1).
put unformatted " " skip.
