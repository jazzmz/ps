...
name-bank = cBankname.
   ...
   if prev-db<>"" then
      h-str = fill(" ",12) + prev-db.
   else
      h-str = fill(" ",29) + prev-cr.
   ...
   form
    ...
    "ÃÄÄÄÄÄÄÂÄÄÄÂÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´" skip
    "³ ®¬¥à³Š®¤³   Š®¤   ³  Š®àà¥á¯®­¤¨àãîé¨© ³         ¡®à®âë ¢ àã¡«ïå        ³          ‘®¤¥à¦ ­¨¥ ®¯¥à æ¨¨          ³" skip
    "³¤®ªã¬.³¤®ª³  ¡ ­ª   ³        áç¥â        ³      „¥¡¥â            Šà¥¤¨â    ³                                       ³" skip
    "ÃÄÄÄÄÄÄÅÄÄÄÅÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´" skip
