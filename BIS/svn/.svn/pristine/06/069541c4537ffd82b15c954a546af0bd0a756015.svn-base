...
DEF VAR lLevelRisk   AS CHARACTER LABEL "Уровень риска"
                        VIEW-AS COMBO-BOX LIST-ITEMS "Высокий", "Низкий", "Неуказан"
...
/*         gdAnketaLast = GetLastHistDate(ipName, ipId, gcSotr). */
         RUN GetLastHistoryDate(ipType, INTEGER(ipId), 01/01/1900, OUTPUT gdAnketaLast, OUTPUT cTmp).
...
/* ============ */
{exp-path.i &exp-filename = "'Anketa3.xls'"}
