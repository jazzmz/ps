...
*/
   ...
   FOR EACH pc-trans
      ...
      FOR EACH pc-trans-amt
         ...
         NO-LOCK
         BY pc-trans-amt.amt-code DESCENDING:
      ...
      IF    (loan.cont-code EQ "10570/017")
         OR (loan.cont-code EQ "10570/019")
      THEN dKMSK = dSUMT * 0.025.
      ELSE DO:
         IF (iI EQ 1)
         THEN dKMSK = dSUMT * 0.0185.

         IF (iI EQ 2)
         THEN dKMSK = dSUMT * 0.0195.
      END.
