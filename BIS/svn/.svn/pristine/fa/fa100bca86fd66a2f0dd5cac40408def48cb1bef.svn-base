...
name-bank = cBankname.
   ...
   skip(4)
    ...
    "│                                              за" {term2str beg dob} format "x(25)"                               "│" at 117 skip
    "│"                                                                                                                 "│" at 117 skip
    "│       Балансовый счет : " long-acct format "x(25)" acct-name FORMAT "x(55)"                                                               "│" at 117 skip
    "│"                                                                                                                 "│" at 117 skip
    "│ Сальдо на начало периода :" h-str form "x(62)"                                                                   "│" at 117 skip
    "├────────┬──────┬───┬─────────┬────────────────────┬─────────────────────────────────┬──────────────────────────────┤" skip
    "│  Дата  │ Номер│Код│   Код   │  Корреспондирующий │       Обороты в нац. валюте     │     Содержание операции      │" skip
    "│опер.дня│докум.│док│  банка  │        счет        │      Дебет            Кредит    │                              │" skip
    "├────────┼──────┼───┼─────────┼────────────────────┼────────────────┬────────────────┼──────────────────────────────┤" skip
