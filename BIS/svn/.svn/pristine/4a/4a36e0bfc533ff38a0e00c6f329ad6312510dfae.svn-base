...
{getdates.i}
{exp-path.i &exp-filename = "'TSPP.xls'"}

/******************************************* Реализация */
PUT UNFORMATTED XLHead("Прямые", "CCNCINNNN", "400,73,63,65,63,92,92,115,96").
...
/******************************************* Реализация */
PUT UNFORMATTED XLNextList("Обратные", "CCNCINNNN", "400,73,63,65,63,92,92,115,96").
