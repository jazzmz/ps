    ...
    * сделана из stmtprr1.h - вариант вызова [X]По дням и счет выписки рублевый
...
*/
   ...
   skip(4)
    ...
    "│"      name-bank  form "x(60)"                                                 "│" at 82 skip
    "│"                                                                              "│" at 82 skip
    "│                       Регистр аналитического учета                             │" skip
    "│                                 за" dob form "99.99.99"     		     "│" at 82 skip
    "│"                                                                              "│" at 82 skip
    "│ Балансовый счет : " long-acct format "x(25)" acct-name FORMAT "x(30)"         "│" at 82 skip
    "│"                                                                              "│" at 82 skip
    "│ Сальдо на начало дня :" SUBSTR(h-str, 19) form "x(39)"                        "│" at 82 skip
    "├──────┬─────────────────────────────────┬───────────────────────────────────────┤" skip
    "│ Номер│       Обороты в нац. валюте     │          Содержание операции          │" skip
    "│докум.│      Дебет            Кредит    │                                       │" skip
    "├──────┼────────────────┬────────────────┼───────────────────────────────────────┤" skip
