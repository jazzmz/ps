/*инклюд для вывода в XLS отчета по связанным клиентам (для заемщиков) s*.XLS
автор: Красков А.С., Бакланов А.В.*/
...
"<Created>06.11.2013T12:34:36Z</Created>" + CHR(10) +
...
"<Table ss:ExpandedColumnCount=""12"" ss:ExpandedRowCount=""|AllRows|"" x:FullColumns=""1"" x:FullRows=""1"">" + CHR(10) +
...
"<Column ss:AutoFitWidth=""0"" ss:Width=""34.33""/>" + CHR(10) +
"<Column ss:AutoFitWidth=""0"" ss:Width=""70.04""/>" + CHR(10) +
"<Column ss:AutoFitWidth=""0"" ss:Width=""27.47""/>" + CHR(10) +
"<Column ss:AutoFitWidth=""0"" ss:Width=""42.57""/>" + CHR(10) +
"<Column ss:AutoFitWidth=""0"" ss:Width=""70.26""/>".   
...
FUNCTION XLTitle RETURNS CHAR (INPUT iName as CHAR, INPUT iDate as Date):
DEF VAR ret_str as CHAR.

ret_str = "<Row ss:Height=""19.23"">" + CHR(10) +
          "<Cell ss:Index=""1"" ss:MergeAcross=""10"" ss:StyleID=""s1"" >" + CHR(10) +
          "<Data ss:Type=""String"">Отчет по |iName| за |iDate|</Data>" + CHR(10) +
          "</Cell>" + CHR(10) +
    ...
    ret_str = REPLACE(ret_str,"|iName|",STRING(iName)).
...
"</Cell>" + CHR(10) +
"<Cell ss:Index=""7"" ss:MergeAcross=""4"" ss:StyleID=""s5"" >" + CHR(10) +
"<Data ss:Type=""String"">Учредители</Data>" + CHR(10) +
"</Cell>" + CHR(10) +
"<Cell ss:Index=""12"" />" + CHR(10) +
"</Row>" + CHR(10) +
"<Row ss:Height=""0.89"">" + CHR(10) +
"<Cell ss:Index=""4"" ss:MergeAcross=""7"" ss:StyleID=""s0"" >" + CHR(10) +
"<Data ss:Type=""String""></Data>" + CHR(10) +
"</Cell>" + CHR(10) +
"<Cell ss:Index=""12"" />" + CHR(10) +
"</Row>" + CHR(10) +
...
"</Cell>" + CHR(10) +
"<Cell ss:Index=""8"" ss:MergeDown=""1"" ss:StyleID=""s3"" >" + CHR(10) +
"<Data ss:Type=""String"">Валюта</Data>" + CHR(10) +
"</Cell>" + CHR(10) +
"<Cell ss:Index=""9"" ss:MergeAcross=""1"" ss:MergeDown=""1"" ss:StyleID=""s3"" >" + CHR(10) +
"<Data ss:Type=""String"">Всего в рублях</Data>" + CHR(10) +
"</Cell>" + CHR(10) +
"<Cell ss:Index=""11"" ss:MergeDown=""1"" ss:StyleID=""s3"" >" + CHR(10) +
"<Data ss:Type=""String"">Всего - резерв</Data>" + CHR(10) +
"</Cell>" + CHR(10) +
"<Cell ss:Index=""12"" />" + CHR(10) +
"</Row>" + CHR(10) +
...
"</Cell>" + CHR(10) +
"<Cell ss:Index=""7"" ss:MergeAcross=""4"" ss:StyleID=""s6"" >" + CHR(10) +
...
FUNCTION XLAddAcctRow RETURNS CHAR (INPUT cAcct as CHAR, INPUT dAmt-rub as DEC, INPUT dAmt-cur as dec, INPUT dAmt-all as dec, INPUT dAmt-res as dec):
...
"</Cell>" + CHR(10) +
"<Cell ss:Index=""8"" ss:MergeDown=""1"" ss:StyleID=""s9"" >" + CHR(10) +
"<Data ss:Type=""Number"">|Amt-cur|</Data>" + CHR(10) +
"</Cell>" + CHR(10) +
"<Cell ss:Index=""9"" ss:MergeAcross=""1"" ss:MergeDown=""1"" ss:StyleID=""s9"" >" + CHR(10) +
"<Data ss:Type=""Number"">|Amt-all|</Data>" + CHR(10) +
"</Cell>" + CHR(10) +
"<Cell ss:Index=""11"" ss:MergeDown=""1"" ss:StyleID=""s10"" >" + CHR(10) +
"<Data ss:Type=""Number"">|Amt-res|</Data>" + CHR(10) +
"</Cell>" + CHR(10) +
"<Cell ss:Index=""12"" />" + CHR(10) +
"</Row>" + CHR(10) +
...
ret_str = REPLACE(ret_str,"|Amt-res|",TRIM(STRING(dAmt-res,"->>>>>>>>>>>>>>9.99"))).
...
"<Data ss:Type=""String""></Data>" + CHR(10) +
"</Cell>" + CHR(10) +
"<Cell ss:Index=""4"" ss:MergeAcross=""6"" ss:StyleID=""s12"" >" + CHR(10) +
"<Data ss:Type=""String"">Всего по клиенту : </Data>" + CHR(10) +
"</Cell>" + CHR(10) +
"<Cell ss:Index=""11"" ss:StyleID=""s13"" >" + CHR(10) +
...
ret_str = 
"<Row ss:Height=""10.99"">" + CHR(10) +
"<Cell ss:Index=""1"" ss:MergeAcross=""9"" ss:StyleID=""s18"" >" + CHR(10) +
"<Data ss:Type=""String"">Всего по группе : </Data>" + CHR(10) +
"</Cell>" + CHR(10) +
"<Cell ss:Index=""11"" ss:StyleID=""s17"" >" + CHR(10) +
"<Data ss:Type=""Number"">|TotalAmt|</Data>" + CHR(10) +
"</Cell>" + CHR(10) +
"<Cell ss:Index=""12"" />" + CHR(10) +
"</Row>".
