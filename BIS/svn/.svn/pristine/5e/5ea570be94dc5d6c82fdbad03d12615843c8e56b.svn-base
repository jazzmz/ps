...
/*    doc.details = "Зачисление на счет невыясненных сумм п.п. " + op.doc-num + " от " + STRING(DATE(GetXAttrValueEx("op",STRING(op.op),"СписСчета","")),"99.99.9999"). */
 ...
 * Автор: Маслов Д. А.   *
 * Event:#637            *
 * В содержании ДАТА ОТ  *
 *                       *
 *************************/  

doc.details = "Зачисление на счет невыясненных сумм п.п. N" + op.doc-num + " от " + STRING(op.doc-date,"99.99.9999").
doc.doc-date = op.due-date.

/*doc.details = "Зачисление на счет невыясненных сумм п.п." + " от " + STRING(op.due-date,"99.99.9999").
  doc.doc-date = DATE(GetXAttrValueEx("op",STRING(op.op),"СписСчета","")).*/
