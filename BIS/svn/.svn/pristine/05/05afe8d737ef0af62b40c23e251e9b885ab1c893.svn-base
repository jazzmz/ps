...
PUT UNFORMATTED "Приложение №13" AT 155 SKIP
                "к форме отчетности 0409135 " AT 155 SKIP(3) 
                "Остатки по наращенным и не отраженным на балансе процентам" AT 35 Skip 
		"по обязательствам банка" at 53 skip(1) 
		"по состоянию за " at 52 repDate FORMAT "99/99/9999" SKIP(1).
...
END.
			...
			PUT UNFORMATTED  "Контролер Начальник У-5      ______________  Маршева Е.М." SKIP(1).
