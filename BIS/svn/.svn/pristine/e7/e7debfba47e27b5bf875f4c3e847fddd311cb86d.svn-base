...
/** 
		Формирование распоряжения на учет зачисленного долга по договору МБК.
		
		Бурягин Е.П., 17.04.2007 17:51
...
DEF VAR loanParam AS INTEGER INIT 0 NO-UNDO.
DEF VAR acctType AS CHAR INIT "Кредит" NO-UNDO.
...
FOR EACH tmprecid NO-LOCK,
  ...
  :
  	...
  	str[1] = "#tabУчесть сумму, зачисленную на счет №" + account + ", в размере "
  	       + STRING(amount) + " (" + strAmount[1] + "), как погашение основного долга по предоставленному "
  	       + client + " МБК в рамках Генерального Соглашения №"
