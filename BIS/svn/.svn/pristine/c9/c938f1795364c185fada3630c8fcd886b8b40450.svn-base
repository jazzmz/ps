...
/* ------------------------------------------------------
     File: $RCSfile: pirloan030.p,v $ $Revision: 1.4 $ $Date: 2011-02-15 14:45:58 $
     Copyright: ООО КБ "Пpоминвестрасчет"
     Базируется: 
     Причина: 
     Что делает: Формирует печатную форму распоряжения по продлению срока возврата кредита.
     Как работает: 
     Параметры: 
...
DEF VAR str AS CHAR EXTENT 15. /** Текст распоряжения */
...
FOR FIRST tmprecid NO-LOCK,
	...
	:
		...
		str[1] = "#tabПродлить по " + STRING(loan.end-date, "99.99.9999") + " вкл. срока возврата кредита, выданного по "
		         + "Кредитному договору №" + loaninfo + ", заключенному между " + client + " и " + bankname + "."
