...
put unformatted "                              ¯® á®áâ®ï­¨î ­  "  string(today,"99/99/9999") "£." skip(2).
...
for each code where code.class = cat-line and
		    code.parent = cat-line  
		    break by code.code.
   sig = 0.	
   for each bal-acct where bal-acct.bal-acct1 = code.code break by bal-acct.bal-acct:
  ...
  for each bal-acct where bal-acct.bal-acct1 = code.code break by bal-acct.acct-cat by bal-acct.bal-acct:
    fd = 01.01.9999.
