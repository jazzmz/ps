...
/*
   ...
   Parameters: Input: RID -  RecID(op)
      ...
      Used by:
      Created: 13/06/06 17:26:37
     Modified:
*/
Form "~n@(#) memorr.p 1.0 RGen 13/06/06 RGen 13/06/06 [ AutoReport By R-Gen ]"
...
put unformatted " Сумма  │ " AmtStr[1] Format "x(70)"
                "" skip.
put unformatted "прописью│ " AmtStr[2] Format "x(70)"
                "" skip.
put unformatted "────────┴───────────────────────────┬───────┬───────────────────────────────────" skip.
put unformatted "" PlName[1] Format "x(35)"
                " │ Сумма │ " Rub Format "x(15)"
                "" skip.
