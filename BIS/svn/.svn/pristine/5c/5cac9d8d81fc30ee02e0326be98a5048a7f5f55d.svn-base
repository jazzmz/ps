	...
	*/
	...
	IF loan.cust-cat = "Ю" THEN
		DO:
			...
			/* #4184 по письму Балан - исправить вывод в Мастер Договоров - нужен юр.адрес из анкеты клиента */
				FIND LAST cust-ident WHERE
			                cust-ident.cust-code-type = "АдрЮр"
			...
			/* #4184 юр.адрес на экспорт - старый 2й параметр записан ниже */
