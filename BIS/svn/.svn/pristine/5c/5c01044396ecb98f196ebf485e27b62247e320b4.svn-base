...
message "totalNalog="   totalNalog .*/
		...
		DO:		
			tmpStr[1] = 'В соответствии с Положением Банка России №39-П от 26.06.1998г. перевести начисленные  ' +
			...
			'на счет №' + GetLoanAcct_ULL(loan.contract, loan.cont-code, PAYOUT_ACCT_NAME, periodEnd, false) + ' (' +
