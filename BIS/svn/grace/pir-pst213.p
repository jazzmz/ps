...
/*        message "Повторный запуск по договору " loan.cont-code VIEW-AS ALERT-BOX.*/
   ...
   IF GetXattrValueEx("loan-cond", loan-cond.contract + "," 
                                 + loan-cond.cont-code + "," 
                                 + STRING(loan-cond.since,"99/99/99"), "Грейс","Нет") = "Нет" then bDel = true.
/*   message GetXattrValueEx("loan-cond", loan-cond.contract + "," 
                                 + loan-cond.cont-code + "," 
                                 + STRING(loan-cond.since,"99/99/99"), "Грейс","Нет") VIEW-AS ALERT-BOX.*/
