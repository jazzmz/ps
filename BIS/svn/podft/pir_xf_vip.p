...
*/
    ...
    NO-ERROR.
    ttBeneficiaryBusinessmen.addressOfLaw = IF AVAIL(cust-ident) THEN cust-ident.issue ELSE ?.
    ...
    FIND FIRST cust-ident WHERE
         ...
         AND cust-ident.close-date     EQ ?
    NO-ERROR.
    ttBeneficiaryBusinessmen.addressOfStay = IF AVAIL(cust-ident) THEN cust-ident.issue ELSE ?.
    ...
    FIND FIRST cust-ident WHERE
         ...
         AND cust-ident.close-date     EQ ?
    NO-ERROR.
    ttBeneficiaryBusinessmen.addressOfPost = IF AVAIL(cust-ident) THEN cust-ident.issue ELSE ?.
