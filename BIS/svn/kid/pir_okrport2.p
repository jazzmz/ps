...
/** 
   ...
   Объем кредитного портфеля на дату.
...
DEFINE VARIABLE cMAcct3   AS CHARACTER           NO-UNDO.
ASSIGN
   cMAcct1[2] = "!45415*,!45515*,!45315*,!45715*,454*,455*,457*,45815*,45817*"
   cMAcct1[3] = "!45115*,!45215*,!45615*,451*,452*,453*,456*,45811*,45812*,45813*,45814*,45816*"
   cMAcct1[4] = "!32015*,!32115*,!32215*,!32315*,!32415*,320*,321*,323*,324*"
   cMAcct1[5] = "!51415*,!51515*,514*,515*"
   cMAcct1[6] = "!50219*,!50319*,501*,502*,503*"
   ...
   cMAcct3    = "!45415*,!45515*,!45315*,!45715*,454*,455*,457*,45815*,45817*,"
              + "!45115*,!45215*,!45615*,451*,452*,453*,456*,45811*,45812*,45813*,45814*,45816*,"
              + "!32115*,!32315*,!32415*,321*,323*,324*,!50219*,!50319*,501*,502*,503*"
   NO-ERROR.
...
DO iI = 2 TO 6:
   ...
   FOR EACH acct
      ...
      THEN DO:
         ...
         cTmp   = SUBSTRING(GetXAttrValue("acct", acct.acct + "," + acct.currency, "ГрРиска"), 1, 1).
         grrisk = INTEGER(cTmp) NO-ERROR.

         IF    ERROR-STATUS:ERROR
            OR (grrisk EQ 0)
         THEN dSRisk[6]      = dSRisk[6]      + sh-in-bal.
         ELSE dSRisk[grrisk] = dSRisk[grrisk] + sh-in-bal.
      END.
   END.
...
PUT UNFORMATTED
   "                 Объем кредитного портфеля на " STRING(end-date, "99.99.9999")  SKIP
   "                       (без учета прав требования)                            " SKIP(1)
   "┌──────────────────────────────────────┬────────────────────┬────────────────┐" SKIP
   "│             Наименование             │   Сумма остатков   │Доля в кредитном│" SKIP
   "│                                      │                    │  портфеле, %%  │" SKIP
   "╞══════════════════════════════════════╪════════════════════╪════════════════╡" SKIP
   "│1. Объем кредитного портфеля          │"
   ...
   "├──────────────────────────────────────┼────────────────────┼────────────────┤" SKIP
   "│3. Кредиты, выданные юридическим лицам│"
      dSumm[3] FORMAT " ->>,>>>,>>>,>>9.99 │"
   ...
   "├──────────────────────────────────────┼────────────────────┼────────────────┤" SKIP
   "│5. Приобретенные векселя              │"
      dSumm[5] FORMAT " ->>,>>>,>>>,>>9.99 │"
     (dSumm[5] * 100.0 / dSumm[1]) FORMAT "       >>9.99   │" SKIP
   "├──────────────────────────────────────┼────────────────────┼────────────────┤" SKIP
   "│6. Иные ценные бумаги                 │"
      dSumm[6] FORMAT " ->>,>>>,>>>,>>9.99 │"
...
PUT UNFORMATTED SKIP(3)
   "        Группировка кредитного портфеля по срокам выдачи на " STRING(end-date, "99.99.9999")  SKIP
   "         (без учета вложений в МБК, ценные бумаги и права требования)"          SKIP(1)
   "┌────────────────────────────────────────────────┬───────────────────────────┐" SKIP
   "│             Наименование                       │      Сумма остатков       │" SKIP
   "╞════════════════════════════════════════════════╪═══════════════════════════╡" SKIP
   "│ 1. В режиме 'овердрафт'                        │"
      dSumm[1]   FORMAT  "     ->>,>>>,>>>,>>9.99    │" SKIP
   "├────────────────────────────────────────────────┼───────────────────────────┤" SKIP
   "│ 2. до востребования                            │"
...
PUT UNFORMATTED SKIP(3)
   "   Группировка кредитного портфеля по категориям качества на " STRING(end-date, "99.99.9999")  SKIP
   "       (без учета вложений в МБК, ценные бумаги и права требования)"            SKIP(1)
   "┌────────────────────────────────────────────────┬───────────────────────────┐" SKIP
   "│              Категория качества                │      Сумма остатков       │" SKIP
   "╞════════════════════════════════════════════════╪═══════════════════════════╡" SKIP
   "│                     1-я                        │"
