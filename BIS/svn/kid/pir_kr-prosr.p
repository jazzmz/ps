...
/*
   Отчет "Просроченная ссудная задолженность"
   ТЗ Красновой
...
"              Просроченная ссудная задолженность на " STRING(end-date) SKIP(2)
"┌─────┬───────────────────────────────────┬──────────────┬─────────────────────┐" SKIP
"│  №  │       НАИМЕНОВАНИЕ ЗАЕМЩИКА       │ № КРЕДИТНОГО │ СУММА ПРОСРОЧЕННОЙ  │" SKIP
"│ П/П │                                   │   ДОГОВОРА   │ССУДНОЙ ЗАДОЛЖЕННОСТИ│" SKIP
"├─────┴───────────────────────────────────┴──────────────┴─────────────────────┤" SKIP
.
