...
/**
		Распоряжение на безакцептное списание суммы в счет погашения просроченных процентов.
		
		Бурягин Е.П., 09.04.2007 10:39
...
FOR FIRST tmprecid NO-LOCK,
    ...
    :
		...
		to_acct = GetLoanAcct_ULL(loan.contract, loan.cont-code, iParam , orderDate, false).
		...
		str[1] = "#tabСписать в безакцептном порядке со счета №" + from_acct + " с последующим зачислением на счет №"
					...
					+ "просроченных процентов за пользование кредитом по Кредитному договору №" 
