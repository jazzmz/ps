...
&ENDIF
     ...
     "───────────────────────┴───────────────────────┤      │"                               SKIP
      ...
      PoName[5] Format "x(46)"           "│Вид оп│" /* #2895 op.doc-type */  vReplDocType  Format "x(2)" "    │Срок плат│" SPACE(0) op.due-date Format "99.99.9999"skip
