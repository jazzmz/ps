...
/* ------------------------------------------------------
     File: $RCSfile: i56_vdb1_318.p,v $ $Revision: 1.4 $ $Date: 2008-11-18 08:18:06 $
     Copyright: ООО КБ "Пpоминвестрасчет"
     Базируется: i56_vdb1.p (from src-local) 
     Причина: 318-П
     Что делает: 
     Как работает: 
     Параметры: 
     ...
     Изменения: Revision 1.1  2008/09/01 08:07:47  Buryagin
     Изменения: Created for the 318-P
     Изменения:
------------------------------------------------------ */
