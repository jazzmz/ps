...
$resultofdecription=C:\test\nbki\cryptcp.exe -nochain -decr -dn $dn $pathwithfiles\$filename.enc $pathwithfiles\$filename
...
C:\test\nbki\7z.exe e $pathwithfiles\$filename $pathtoextract -y
...
mv -Force $pathwithfiles\V* $pathwithfiles\ARCHIVE\$currYear\$currMonth\$currDay
