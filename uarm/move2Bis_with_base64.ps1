...
dir -filter 4585* $TEMP_DIR | filterByExcludeList | filterByPacketType "ED101" | % { 
echo "ED101 $_";
$FILENAME=$ARM_PATH + "\" + $_.Name; 
cp $FILENAME $BIS_IN;  
	if ($?) {
...
#
dir -filter "*" $TEMP_DIR_ED | filterByExcludeList | filterByPacketType_ED "ED374" | % {
echo "SPRAV $_";
$FILENAME=$ARM_PATH + "\" + $_.Name; 
